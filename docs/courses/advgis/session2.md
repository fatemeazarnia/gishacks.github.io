...
ارتفاعی را در اختیار ما قرار دهد سایت https://opentopography.org/  است. که با مراجعه به این سایت و از قسمت Data و find data map با فیلترشکن از نقشه مورد نظر محدوده خود را انتخاب می کنیم. سپس از بین فایل های ارائه شده یکی را انتخاب می کنیم. برحسب جست و جست و جو در اینترنت   دو مورد آخر برای کار برنامه ریزی شهری مناسب تر هستند.  و ر با دانلود strm-gl1  می‌توانیم داده‌های مربوط به ارتفاع را به صورت
رستری داشته باشیم.

**رستر ارتفاع تهران**
![توضیح تصویر](https://www.dropbox.com/scl/fi/wpzg3izayd1j2fs2bmtkp/.png?rlkey=6tmif8crcec78x0xsj83ydro4&st=7hymgl6z&dl=1)
...
که ارزش بخش‌هایی که بین نقاط قرار گرفتند را برای ما مشخص می‌کند.البته اگر با کل تهران کار می کنیم چون محدوده بزرگ است خیلی ضروری نیست که سایز
سلول ها را تغییر دهیم برای محدوده های کوچکتر بیشتر کاربرد دارد. این روش یک میانبر برای افزایش کیفیت می باشد.

**تبدیل رستر به نقطه با ابزار  raster pixels to points**
![توضیح تصویر](https://www.dropbox.com/scl/fi/8bryjk68ta7up0fawj70v/4.png?rlkey=6ksighm8hi93jzpmxnfmvdteh&st=yp2rr5l7&dl=1)
**تحلیل idw**
![توضیح تصویر](https://www.dropbox.com/scl/fi/aet2c1d37wdgr414r0o0e/.png?rlkey=94vh5jd4h6185nwllcyetvmgi&st=zy2aeuib&dl=1)

فارغ از این‌ها از آنجایی که ما داده‌ی ارتفاعی را داریم می‌توانیم
تحلیل‌های سطح از جمله شیب، جهت شیب را انجام دهیم.
**تحلیل شیب/** **slope**
![توضیح تصویر](https://www.dropbox.com/scl/fi/oxp5gzynay4rwifi8aozs/6.png?rlkey=3m0cdo35cvn5in7txetp2xdo9&st=vpkxbdcx&dl=1)
...
استفاده کنیم  یک دستور r.slope.aspect هم وجود دارد که زیر مجموعه GRASS می باشد که هم شیب و جهت شیب را به دست می دهد و کاملترین هست و اندازه گیری بر حسب درصد یا درجه را می توان از منو format مشخص کرد.
 که خروجی آن نقشه بهتری نسبت به ابزار قبلی به ما می‌دهد و شیب
...
تحلیل جهت شیب برای نورگیری بسیار مهم می باشد. مثلا شمال و جنوب دماوند درجه شیب مشابهی دارند اما جهت جنوب صعود راحت تر و جهت شمال صعود دشوار و شرایط یخبندان دارد. به همین منظور جهت شیب در برنامه ریزی شهری مثلا برای تخمین معابری که در زمستان بیشتر یخ می بندند مفید می باشد. زمانی که تحلیل شیب انجام می‌دهیم درجه‌ای که به ما می‌دهد،
...
آزیموف Azimuth به معنای موقعیت قرار‌گیری خورشید در آسمان است که به توجه به اینکه خورشید از شرق طلوع و غرب، غروب می‌کند، (صبح در شرق و غروب
در غرب یعنی بین 90 تا 180 و 180 تا 270) (چون ما نیمکره شمالی هستیم خورشید را در جنوب می بینیم). پس این عدد اگر صبح مد نظر ماست بین 90 تا 120 و اگر ظهر مد نظر ماست بین 170 تا 190 و اگر غروب مد نظر ماست باید بین 240 تا 270 باشد.
.

ورتیکال انگل Vertical angle به معنای موقعیت خورشید نسبت به سال است که ما در کدام فصل قرار داریم، در تابستان نزدیک به ۹۰ درجه و در زمستان نزدیک صفر تا ۳۰ درجه است. برای داشتن بیشترین سایه vertical angle را زمستان حدود 0 و azimuth را حدود صبح یا عصر می گذاریم..
...
این تحلیل مناسب طرح های آماده سازی می باشد و به دو لایه ارتفاعی نیاز دارد یکی قبل از مداخله و دیگری بعد از مداخله، و حجم و سطح و محل خاک ریزی و خاک برداری را محاسبه می کند که در برآورد هزینه های پروژه اهمیت دارد.
**تحلیل قابلیت دیدن**
